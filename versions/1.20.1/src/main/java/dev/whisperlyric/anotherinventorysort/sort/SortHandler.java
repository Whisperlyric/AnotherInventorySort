...
public class SortHandler {
    ...
    private static void mergeSameTypeItems(Minecraft client, AbstractContainerMenu menu,
        ...
        for (var entry : itemsByType.entrySet()) {
            ...
            for (int i = 1; i < positions.size(); i++) {
                ...
                client.gameMode.handleInventoryMouseClick(containerId,
                        slotIndices.get(sourcePos), 0, ClickType.PICKUP, client.player);
                client.gameMode.handleInventoryMouseClick(containerId,
                        slotIndices.get(targetPos), 0, ClickType.PICKUP, client.player);
    ...
    private static void doSwap(Minecraft client, int containerId, List<Integer> slotIndices,
        ...
        client.gameMode.handleInventoryMouseClick(containerId, srcSlot, 0, ClickType.PICKUP, client.player);
        client.gameMode.handleInventoryMouseClick(containerId, tgtSlot, 0, ClickType.PICKUP, client.player);
        client.gameMode.handleInventoryMouseClick(containerId, srcSlot, 0, ClickType.PICKUP, client.player);
    }
